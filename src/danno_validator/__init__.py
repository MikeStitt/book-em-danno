...
drives a tiered test battery against the harness-under-test, judges results, and
emits a Sphinx report plus an annotated "menu" danno.toml. Design of record:
`.docs/plan-danno-validator.md`.

The opencode-only-in-sandbox invariant holds: the harness-under-test runs only in
