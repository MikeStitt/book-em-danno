# danno portability probe — Windows / powershell

- **when (UTC):** 2026-07-09T20:21:29.460098+00:00
- **platform / arch:** `win32` / `AMD64`  
- **os:** Windows 11
- **python:** 3.14.2 (`C:\projects\try-danno\powershell\book-em-danno\.venv\Scripts\python.exe`)
- **cwd:** `C:\projects\try-danno\powershell\book-em-danno`
...
| tool | path |
|---|---|
| danno | C:\projects\try-danno\powershell\book-em-danno\.venv\Scripts\danno.EXE |
